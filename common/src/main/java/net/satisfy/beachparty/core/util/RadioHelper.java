...
public class RadioHelper {
    ...
    private static void addSounds(BlockPos blockPos) {
        ...
        for (RegistrySupplier<SoundEvent> sound : SoundEventRegistry.RADIO_SOUNDS) {soundInstance.add(new SimpleSoundInstance(sound.get().getLocation(), SoundSource.RECORDS, 0.6f, 1.0f, RandomSource.create(), true, 0, SoundInstance.Attenuation.LINEAR, blockPos.getX(), blockPos.getY(), blockPos.getZ(), false));
