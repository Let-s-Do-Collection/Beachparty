...
**Fixed**
* Hanging Coconut, Empty Sand Bucket, and Filled Sand Bucket now correctly drop themselves when broken
* Fixed loot table ID mismatches for several blocks, ensuring drops behave as expected
* Palm Logs not being strippable 
